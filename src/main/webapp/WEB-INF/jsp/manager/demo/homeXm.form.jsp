                    ...
                    <div class="baodan_right">
                        <div class="paiming_top" >
                            ...
                            <div class="paiming_top_border" style="width:50%;float: right">
                                ...
                                <p class="danshu_style font_color_2">6811.53<font>万元</font></p>
                    ...
                    <div class="form2_box_left">
                        ...
                        <div style="height: 100%;width: 18%; float: left;">
                            ...
                            <table class="graph_overdue_center">
                                ...
                                <%--<tr>
                                    <td>${yuqilvXm[0].gname == null?"暂无":yuqilvXm[0].gname}</td>
                                    <td>${yuqilvXm[0].yuqilv == null?0:yuqilvXm[0].yuqilv}%</td>
                                </tr>
                                <tr>
                                    <td>${yuqilvXm[1].gname == null?"暂无":yuqilvXm[1].gname}</td>
                                    <td>${yuqilvXm[1].yuqilv == null?0:yuqilvXm[1].yuqilv}%</td>
                                </tr>
                                <tr>
                                    <td>${yuqilvXm[2].gname == null?"暂无":yuqilvXm[2].gname}</td>
                                    <td>${yuqilvXm[2].yuqilv == null?0:yuqilvXm[2].yuqilv}%</td>
                                </tr>
                                <tr>
                                    <td>${yuqilvXm[3].gname == null?"暂无":yuqilvXm[3].gname}</td>
                                    <td>${yuqilvXm[3].yuqilv == null?0:yuqilvXm[3].yuqilv}%</td>
                                </tr>
                                <tr>
                                    <td>${yuqilvXm[4].gname == null?"暂无":yuqilvXm[4].gname}</td>
                                    <td>${yuqilvXm[4].yuqilv == null?0:yuqilvXm[4].yuqilv}%</td>
                                </tr>--%>
                                <tr>
                                    <td>购车无忧汽车服务</td>
                                    <td>0.42%</td>
                ...
                <div class="paiming_table">
                    ...
                    <table class="graph_overdue_center yuqigd">
                        ...
                        <%--<c:forEach items="${ count }" var="rank" varStatus="lists">
                            <tr>
                                <td>${yuqilvXm[lists.count-1].gname == null?"暂无":yuqilvXm[lists.count-1].gname}</td>
                                <td>${yuqilvXm[lists.count-1].yuqilv == null?0:yuqilvXm[lists.count-1].yuqilv}%</td>
                            </tr>
                        </c:forEach>--%>
                        <tr>
                            <td>购车无忧汽车服务</td>
