                ...
                <div class="visual_form_box">
                    ...
                    <div class="baodan_right">
                        ...
                        <div style="height: 70%; width: 100%;">
                            <div id="kehunianling" style="height: 90%;width: 100%;position: relative; ">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="form2_box_left">
                        ...
                        <div style="height: 100%;width: 18%; float: left;">
                            ...
                            <table class="graph_overdue_center">
                                ...
                                <tr>
                                    <td>${yuqilvHx[1].gname == null?"暂无":yuqilvHx[1].gname}</td>
                                    <td>${yuqilvHx[1].yuqilv == null?0:yuqilvHx[1].yuqilv}%</td>
                                </tr>
                                <tr>
                                    <td>${yuqilvHx[2].gname == null?"暂无":yuqilvHx[2].gname}</td>
                                    <td>${yuqilvHx[2].yuqilv == null?0:yuqilvHx[2].yuqilv}%</td>
                                </tr>
                                <tr>
                                    <td>${yuqilvHx[3].gname == null?"暂无":yuqilvHx[3].gname}</td>
                                    <td>${yuqilvHx[3].yuqilv == null?0:yuqilvHx[3].yuqilv}%</td>
                                </tr>
                                <tr>
