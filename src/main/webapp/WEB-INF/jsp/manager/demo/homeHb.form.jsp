                        ...
                        <div class="paiming_top" >
                            <div class="paiming_top_border" style="width:40%;float: left">
                                <%--<p class="danshu_style font_color_2">${billlistHb[0].amount }<font>笔</font></p>--%>
                                    <p class="danshu_style font_color_2">${billlistHb[0].amount+3000 }<font>笔</font></p>
                        ...
                        <div class="paiming_top" style="margin-top: 0;margin-left: 10px;">
                            <div class="paiming_bottom_border" style="width:46%;float: left;">
                                <%--<p class="danshu_style font_color_2">${fklistHb[0].amount }<font>笔</font></p>--%>
                                    <p class="danshu_style font_color_2">2040<font>笔</font></p>
                            ...
                            <ul class="font_color_1 condition1" >
                                ...
                                <li>
                                    <select id="zhengxintime" onchange="zhengxinselect()">
                                        ...
                                        <option value="3">19年2月</option>
                                        <option value="4">19年1月</option>
                                        <option value="5">18年12月</option>
                                        <option value="6">18年11月</option>
                                        <option value="7">18年10月</option>
                                        <option value="8">18年9月</option>
                                        <option value="9">18年8月</option>
                                        <option value="10">18年7月</option>
                                        <option value="11">18年6月</option>
                                        <option value="12">18年5月</option>
                                        <option value="13">18年4月</option>
                                        <option value="14">18年3月</option>
                                        <option value="15">18年2月</option>
                                        <option value="16">18年1月</option>
                                    </select><i style="padding-left: 5px; font-weight:bold;">></i>
                                </li>
                            </ul>
                        </div>
...
<script type="text/javascript" src="${pageContext.request.contextPath }/manager/js/visual/visualHb1.js"></script>
