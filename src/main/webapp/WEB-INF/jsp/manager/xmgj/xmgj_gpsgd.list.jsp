                ...
                <div class="col-sm-12">
                    <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                        ...
                        <tr role="row" class="odd">
                            ...
                            <td class="hidden-xs text-center">
                                <a href="/manager/index?cn=xmgj_gpsgd&sdo=list&type=xmgj&fsid=<%=m.get("fsid")%>"><%=m.get("fsname")%></a>
                            </td>
                            <td class="text-center">
                            ...
                            <td class="text-center">
                                <div class="table-button">
                                    ...
                                    <a href="index?cn=ddjd&sdo=form&type=tyjj&icbc_id=<%=m.get("icbc_id")%>&id=<%=m.get("id")%>&tab=34" class="btn btn-default">
