...
<div class="admin-content nav-tabs-custom box">
    <div class="box-header with-border">
        ...
        <div class="box-body" id="tab-content">
            ...
            <div class="form-group">
                <label class="col-sm-2 control-label">公司合同材料信息</label>
                <div class="col-sm-10">
                    <div class="row inline-from">
                        <%
                            String upFile1 = "../upfile.inc.jsp";
                            String imgPreName1 = "imgstep13_1ss";
                        ...
                        <input id="<%=imgPreName1%>_num" name="<%=imgPreName1%>_num" type="hidden" value="<%=imgs_length%>" />
                    </div>
                </div>
            </div>
											<div class="form-group">
                <label class="col-sm-2 control-label">PDF上传
                </label>
                <div class="col-sm-10">
                    <div class="row inline-from">

                        <%
                            String upFilePdf = "../upfile_pdf.inc.jsp";
                            String imgPreName2 = "pdfstep4_1";
                        ...
                        <jsp:include page="<%=upFilePdf%>">
                            ...
                            <jsp:param name="img_DefaultImgSrc" value="images/mgcaraddimg.jpg"/>
                            <jsp:param name="l1div_Style"
                                       value="width: 220px;height:200px;display: inline-block;text-align: center;margin: auto;"/>
                            <jsp:param name="img_Style" value="width: 100%;height:164px;border-radius:10px;"/>
                            <jsp:param name="img_FileStyle"
                                       value="position: absolute;left: 0;top: 0;height: 100%;width: 100%;background: transparent;border: 0;margin: 0;padding: 0;filter: alpha(opacity=0);-moz-opacity: 0;-khtml-opacity: 0;opacity: 0;"/>
                            <jsp:param name="img_Class" value="imgclass"/>
                            <jsp:param name="img_FileClass" value="uploadfileclass"/>
                    ...
                    <div class="row inline-from">
                        ...
                        <div class="col-sm-4">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" readonly="" value="投保材料">
                            </div>
                        </div>
                    </div>
                </div>
