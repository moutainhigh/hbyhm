...
var App = function() {
    ...
    var basePath = '/manage/iframe/';

    var globalImgPath = 'iframe/dist/img/';

    var globalPluginsPath = 'iframe/base/plugins/';

    var globalCssPath = 'iframe/dist/css/';
    ...
    $.fn.sidebarMenu = function(options) {
        ...
        function init($menu_ul, data, level) {
            $.each(data, function(i, item) {
                ...
                var $a;
                if (level > 0) {
                    $a = $('<a style="padding-left:' + (level * 35) + 'px"></a>');
                } else {
                    $a = $('<a></a>');
                }
