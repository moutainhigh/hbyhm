 ...
 * @Author: tt
 * @LastEditors: tt
 * @Date: 2019-01-08 17:19:43
 * @LastEditTime: 2019-03-16 11:36:05
 */
/**
 * @version: 1.3.21
...
(function(root, factory) {
  ...
  var DateRangePicker = function(element, options, cb) {
    ...
    var DRPTemplate = '<div class="daterangepicker dropdown-menu">' +
      ...
      '<input class="input-mini" type="text" style="width:100%;" name="daterangepicker_start" value="" />' +
      '</div>' +
      '<div class="daterangepicker_end_input" style="padding: 0px;width:100%;">' +
      '<label for="daterangepicker_end"></label>' +
      '<input class="input-mini" type="text" style="width:100%;" name="daterangepicker_end" value="" />' +
      '</div>' +
      '<button class="applyBtn" disabled="disabled" style="width:45%;"></button>&nbsp;' +
      '<button class="cancelBtn" style="width:45%;"></button>' +
      '</div>' +
      '</div>' +
      '</div>';
