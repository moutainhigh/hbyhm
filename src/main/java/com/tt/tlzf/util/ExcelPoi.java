...
//
//        List<List<String>> list = poi.read("C:\\Users\\86176\\Desktop\\工作日志\\支付对接\\银行代码.xlsx");
//
...
//                    ttMap.put("code","0"+cellList.get(0));
//                    ttMap.put("name",cellList.get(1));
//                }
//                System.out.println();
//                ttList.add(ttMap);
//            }
...
//        for(TtMap ttMap:ttList){
//            Tools.recAdd(ttMap,"tlzf_bankcode");
//        }
//
//    }
//
