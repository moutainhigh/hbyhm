...
public class ImgTools {
    ...
    private static BufferedImage getRoundedImage(BufferedImage img, int size, int radius, int type, int height,
        ...
        if (!shuiyfile.equals("")) {
            try {
                ...
                g.drawImage(suiyin, size - 5 - suiyin.getWidth(), (type == 3 ? height : size) - 5 - suiyin.getHeight(),
                        null);// 在适当的位置画出水印
            } catch (Exception E) {
    ...
    public static void main3(String[] args) throws IOException {
        shuiy("/work/sd128/work/source/JAVA/springboot1/src/main/webapp/upload/2018/11/23/d4c6fda999b86a966cf71bb69cdee62f.jpg",
