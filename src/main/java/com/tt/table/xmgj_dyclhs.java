...
public class xmgj_dyclhs extends DbCtrl {
    ...
    public void doGetForm(HttpServletRequest request, TtMap post) {
        ...
        String jsonInfo = Tools.jsonEncode(info);TtMap minfo = Tools.minfo();
        ...
        //历史操作查询
        if (nid > 0) {
            TtList lslist = Tools.reclist("select * from xmgj_dyclhs_result where qryid=" + nid);
        ...
        Tools.recEdit(map, "xmgj_dyclhs", nid);
    ...
    public void doPost(TtMap post, long id, TtMap result2) {
        ...
        Tools.recAdd(res, "xmgj_dyclhs_result");
        ...
        if(StringUtils.isNotEmpty(newpost.get("mid_add")) && newpost.get("mid_add").equals(newpost.get("mid_edit"))){
            Addadmin_msg.addmsg(newpost.get("mid_edit"), newpost.get("bc_status"), newpost.get("remark1"), recinfo.get("c_name"), "补寄材料", "厦门国际银行", newpost.get("mid_add"));

        } else {
            Addadmin_msg.addmsg(newpost.get("mid_add"), newpost.get("bc_status"), newpost.get("remark1"), recinfo.get("c_name"),"补寄材料","厦门国际银行", newpost.get("mid_add"));
            Addadmin_msg.addmsg(newpost.get("mid_edit"), newpost.get("bc_status"), newpost.get("remark1"), recinfo.get("c_name"), "补寄材料", "厦门国际银行", newpost.get("mid_add"));
