...
public class dygd extends DbCtrl {
    ...
    public void doGetForm(HttpServletRequest request, TtMap post) {
        ...
        if(!Tools.myIsNull(post.get("toZip"))&& post.get("toZip").equals("1")) {
            ...
            //历史操作查询
            if (nid > 0) {
                TtList lslist = Tools.reclist("select * from hbyh_dygd_result where qryid=" + nid);
            ...
            Tools.recEdit(map, "hbyh_dygd", nid);
    ...
    public void doPost(TtMap post, long id, TtMap result2) {
        ...
        Tools.recAdd(res, "hbyh_dygd_result");
        ...
        if(StringUtils.isNotEmpty(newpost.get("mid_add")) && newpost.get("mid_add").equals(newpost.get("mid_edit"))){
            Addadmin_msg.addmsg(newpost.get("mid_edit"), newpost.get("bc_status"), newpost.get("remark1"), recinfo.get("c_name"), "抵押归档", "河北银行", newpost.get("mid_add"));

        } else {
            Addadmin_msg.addmsg(newpost.get("mid_add"), newpost.get("bc_status"), newpost.get("remark1"), recinfo.get("c_name"),"抵押归档","河北银行", newpost.get("mid_add"));
            Addadmin_msg.addmsg(newpost.get("mid_edit"), newpost.get("bc_status"), newpost.get("remark1"), recinfo.get("c_name"), "抵押归档", "河北银行", newpost.get("mid_add"));
    ...
    public void doGetList(HttpServletRequest request, TtMap post) {
        ...
        String tmpWhere = "";
        String fieldsString = "t.*,f.name as fsname,a.name as adminname,i.c_name as c_name,i.fk_status,i.id as icbc_id,aa.name as aa_name";
