...
public class xmloan_khhklr extends DbCtrl {

    private final String title = "客户还款录入";
    private String orderString = "ORDER BY dt_edit DESC"; // 默认排序
    private boolean canDel = false;
    private boolean canAdd = false;
    private final String classAgpId = "88"; // 随便填的，正式使用时应该跟model里此模块的ID相对应
    public boolean agpOK = false;// 默认无权限

    public xmloan_khhklr() {
        super("xmloan_import_record");
