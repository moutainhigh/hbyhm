 ...
 */
@Controller
public class HXErpdcglController {
    @PostMapping(value = "/manager/jqclajaxposthx")
    @ResponseBody
    public TtMap ajaxposthxjq(HttpServletRequest request) {
        ...
        Tools.recAdd(map, "hxloan_overdue_list_result");
    ...
    @PostMapping(value = "/manager/hxglajaxposthx")
    @ResponseBody
    public TtMap ajaxposthxs(HttpServletRequest request) {
        ...
        switch (post.get("type_status")) {
            case "71":   //未核销的信息录入提交
                ...
                dbTools1.recupdate("update hxloan_overdue_list set type_id=7,type_status=72 where icbc_id="+post.get("icbc_id"));
            ...
            case "72": //已核销的信息录入提交
                ...
                dbTools.recupdate("update hxloan_overdue_list set type_id=6,type_status=" +coolStatus+ " where icbc_id="+post.get("icbc_id"));
    ...
    @PostMapping(value = "/manager/ssglajaxposthx")
    @ResponseBody
    public TtMap ajaxposthxq(HttpServletRequest request) {
        ...
        if ("41".equals(post.get("type_status"))) {   //未诉讼
            DbTools dbTools = new DbTools();
            dbTools.recupdate("update hxloan_overdue_list set type_id=4,type_status=42 where icbc_id="+post.get("icbc_id"));
            ...
            DbTools dbTools = new DbTools();
            dbTools.recupdate("update hxloan_overdue_list set type_id=7,type_status=71 where icbc_id="+post.get("icbc_id"));
    ...
    @PostMapping(value = "/manager/pmglajaxposthx")
    @ResponseBody
    public TtMap ajaxposthxa(HttpServletRequest request) {
        ...
        switch (post.get("type_status")) {
            case "51":   //未拍卖的信息录入提交
                ...
                if ("53".equals(coolStatus)) {  //盈利(拍卖完成)
                    DbTools dbTools = new DbTools();
                    dbTools.recupdate("update hxloan_overdue_list set type_id=5,type_status=53 where icbc_id="+post.get("icbc_id"));
                    ...
                    DbTools dbTools = new DbTools();
                    dbTools.recupdate("update hxloan_overdue_list set type_id=4,type_status=" +coolStatus+ " where icbc_id="+post.get("icbc_id"));
                    ...
                    DbTools dbTools = new DbTools();
                    dbTools.recupdate("update hxloan_overdue_list set type_id=7,type_status=" +coolStatus+ " where icbc_id="+post.get("icbc_id"));
    ...
    @PostMapping(value = "/manager/jrdcajaxposthx")
    @ResponseBody
    public TtMap ajaxposthx(HttpServletRequest request) {
        ...
        switch (post.get("dctype_id")){
            case "1":
                ...
                dbTools.recupdate("update hxloan_overdue_list set type_id=2,type_status=0 where icbc_id="+post.get("icbc_id"));

                String sql = "select * from hxloan_overdue_list where icbc_id = " + post.get("icbc_id");
            ...
            case "2":                       //电催录入栏
                ...
                Tools.recAdd(map1, "hxloan_overdue_list_result");
            break;
            case "3":           //申请拖车||诉讼
                DbTools dbTools1 = new DbTools();
                dbTools1.recupdate("update hxloan_overdue_list set type_id=" + post.get("type_id") + ",type_status=" + post.get("type_status") + " where icbc_id=" + post.get("icbc_id"));
                ...
                Tools.recAdd(map2, "hxloan_overdue_list_result");
                break;
            case "4":           //拖车信息录入栏提交
                ...
                if (post.get("tctype").equals("31")){        //拖车未受理信息录入提交
                    dbTools2.recupdate("update hxloan_overdue_list set type_status=32 where icbc_id=" + post.get("icbc_id"));
                    ...
                    Tools.recAdd(map3, "hxloan_overdue_list_result");
                    ...
                    if ("33".equals(coolStatus)) {
                        dbTools2.recupdate("update hxloan_overdue_list set type_id=3,type_status=33 where icbc_id=" + post.get("icbc_id"));
                        ...
                        dbTools2.recupdate("update hxloan_overdue_list set type_id=7,type_status=71 where icbc_id=" + post.get("icbc_id"));
                    ...
                    if (coolStatus.equals("51")){
                        dbTools2.recupdate("update hxloan_overdue_list set type_id=5,type_status=" + coolStatus + " where icbc_id=" + post.get("icbc_id"));
                    } else {
                        dbTools2.recupdate("update hxloan_overdue_list set type_id=6,type_status=" + coolStatus + " where icbc_id=" + post.get("icbc_id"));
                    }
                    map3.put("type_id", "3");
                    map3.put("type_status", coolStatus);
    ...
    //添加或修改配置
    @PostMapping("/manager/loanConfighx")
    @ResponseBody
    public String loanConfig(
        ...
        //2如果有展示信息，修改提交保存
        //3如果没有填写信息，提交保存
        String configSql = "select * from hxloan_config where gems_fs_id="+pdsession.get("icbc_erp_fsid");
        ...
        Long a = 0L;
        DbCtrl dbCtrl = new DbCtrl(null,"hxloan_config");
